  ...
  return (
    <div className='flex flex-col justify-center items-center my-20'>
        <div className='hidden lg:block'>
            ...
            className='h-[100px] object-cover rounded-full absolute right-36' alt="img"/>
             <Image src='/profile3.png' width={100} height={100}
            className='h-[100px] object-cover rounded-full absolute top-48 left-16' alt="img"/>
             <Image src='/profile2.png' width={100} height={100}
            className='h-[100px] object-cover rounded-full absolute bottom-20 left-36'alt="img"/>
              <Image src='/profile2.png' width={100} height={100}
            className='h-[100px] object-cover rounded-full absolute right-16 bottom-32' alt="img"/>
        </div>
        ...
        <div className='flex gap-4 flex-col mt-5'>
            ...
            <div className='flex justify-center gap-8'>
                <Button className="p-7 flex gap-4 cursor-pointer">
            ...
            <hr></hr>
             <h2><span className='text-primary cursor-pointer'>Sign up Free with Email.</span> No Credit card required</h2>
        </div>
        </div>
    </div>
  )
